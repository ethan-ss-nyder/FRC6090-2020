...
public class RobotMap {
  ...
  public static final int FRONT_RIGHT_DRIVE_MOTOR = 2; /* Module 1 */
  public static final int REAR_LEFT_DRIVE_MOTOR   = 4; /* Module 3 */
  public static final int REAR_RIGHT_DRIVE_MOTOR  = 3; /* Module 4 */
  
  public static final int FRONT_LEFT_PIVOT_MOTOR  = 5;
  public static final int FRONT_RIGHT_PIVOT_MOTOR = 6;
  public static final int REAR_LEFT_PIVOT_MOTOR   = 8;
  public static final int REAR_RIGHT_PIVOT_MOTOR  = 7;
}
