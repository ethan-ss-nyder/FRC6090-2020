...
/**
 * If a swerve module is not fully implemented, it should throw this
 * exception when unimplemented calls are made. This is also used by
 * the driver class when a module does not behave as expected.
